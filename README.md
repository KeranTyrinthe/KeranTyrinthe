...
Développeur web et mobile, Product Designer et UI/UX Designer, je conçois des produits numériques modernes qui réunissent performance technique, identité visuelle et expérience utilisateur.

J’interviens de la réflexion produit jusqu’à la mise en production : recherche et conception UX, création d’interfaces sur Figma, prototypage, développement d’applications web et mobiles, intégration d’API et gestion de bases de données.
